...
<div class="well">
  ...
  <div class="row">
    ...
    <div class="col-md-3">
      <div class="thumbnail">
        <img src="/upload/product/{{$top[$i]->get('file')}}" alt="{{$top[$i]->get('name')}}" style="max-height:80px">
        <div class="caption">
  ...
  <div class="row">
    ...
    <div class="col-md-3">
      <div class="thumbnail">
        <img src="/upload/product/{{$allProduct[$i]->get('file')}}" alt="{{$allProduct[$i]->get('name')}}" style="max-height:80px">
        <div class="caption">
